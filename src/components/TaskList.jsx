        ...
        {filteredTasks.length === 0 ? (
          ...
          filteredTasks.map((task, index) => {
            ...
            return (
              <div
                key={index}
                className="mb-3 p-3 bg-white text-black rounded-2xl flex flex-col gap-4 shadow-lg"
              >
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="w-7 h-7 rounded-full bg-gray-300 hover:bg-red-500 hover:text-white transition-all"
                  >
                    ×
                  </button>
                </div>
